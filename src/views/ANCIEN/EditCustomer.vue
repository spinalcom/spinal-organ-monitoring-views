...
export default {
  ...
  methods: {
    cancelAdd() {
      this.$router.push({ name: 'DetailCustomer', query: { id: this.$route.query.id } });
    },
    addContact() {
