...
<template>
  <v-app class="app">
    ...
    <div v-if="show" class="popup_platform">
      <v-card
        class="popup"
        style="padding-bottom: 100px; padding-left: 20px; padding-right: 20px"
      >
        ...
        <InputUser
          ...
          id="userName"
        />
        <span class="errors" v-if="$v.formServer.name.$error">
          Server Name is required</span
        >
        <InputUser v-model="formServer.type" title="SERVER TYPE" id="type" />
        <span class="errors" v-if="$v.formServer.type.$error">
          Server Type is required</span
        >
        <InputUser
          v-model="formServer.ipAdress"
          title="SERVER IP ADDRESS"
          id="userName"
        />
        <span class="errors" v-if="$v.formServer.ipAdress.$error">
          Server IP is required</span
        >
        <InputUser
          v-model="formServer.macAdress"
          title="SERVER MAC ADRESS"
          id="userName"
        />
        <span class="errors" v-if="$v.formServer.macAdress.$error">
          Server Name is required</span
        >
        <InputUser
          v-model="formServer.sshLogin"
          title="SERVER ssh login"
          id="userName"
        />
        <span class="errors" v-if="$v.formServer.sshLogin.$error">
          Server Name is required</span
        >
        <InputUser
          v-model="formServer.sshPassword"
          title="SERVER ssh password"
          id="userName"
        />
        <span class="errors" v-if="$v.formServer.sshPassword.$error">
          Server ssh password is required</span
        >
